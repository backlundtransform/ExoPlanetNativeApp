...
export let resource = new LocalizedStrings({
 "en-US":{
   ...
   massInfo :'"The planet is of the type Jovian, which means that the planet is a giant like Jupiter or Saturn.","The planet is of the type Neptunian, which means that it has a similar mass like our solar systems smaller gas giants Uranus and Neptune.","The planet is of the type Super-terrestrial, which means that its mass is larger than Earth, but is considerably smaller than our solar systems smaller gas giants Uranus and Neptune.","The planet is of the type terrestrial, which means that it has a similar mass like our solar systems inner planets Mars, Venus and Earth.","The planet is of the type Mercurian, which means that it has a similar mass like our solar systems smallests planets e.g Mercury."',
 ...
 sv:
 {
   ...
   massInfo :'"Planeten är av typen Jovian vilket innebär att planeten är en jätte som Jupiter eller Saturnus. ","Planeten är av typen Neptunian vilket innebär att dess massa är i samma storleks ordning som vårat solsystems mindre gasjättar Uranus och Neptunus.","Planeten är av typen Super-terrestrisk vilket innebär att dess massa är större än Jordens men betydligt mindre än vårat solsystems mindre gasjättar Uranus och Neptunus.","Planeten är av typen terrestrisk vilket innebär att den har likande massa som vårat solsystems inre planeter Mars, Venus och Jorden.","Planeten är av typen Mercurian vilket innebär att den har likande massa som vårat solsystems minsta planeter t.e.x Merkurius."',
