...
export default class TabBar extends React.Component<TabBarProps, TabBarState> {
    ...
    HandleClick = (tab: string) => {
        this.props.navigator.navigate(tab, {
            planet: this.props.navigator.state.params.planet,
        })
    }
    render() {
            ...
            <Header style={styles.tabcontent}>
                <Button
                    ...
                    style={[
                        ...
                        {
                            backgroundColor:
                                tab == 'Planet' ? '#865191' : '#50607a',
                        },
                    ]}
                    onPress={() => this.HandleClick('Planet')}
                >
                    <Icon name={'planet'} />
                </Button>
                ...
                <Button
                    style={[
                        ...
                        {
                            backgroundColor:
                                tab == 'Star' ? '#865191' : '#50607a',
                        },
                    ]}
                    onPress={() => this.HandleClick('Star')}
                >
                    <Icon name={'star'} />
                </Button>
            </Header>
