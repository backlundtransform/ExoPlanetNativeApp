...
export default class SearchPicker extends React.Component<SearchPickerProp, any> {
    ...
    render() {
        ...
        const { onValueChange,value,searcharray,statekey, title} = this.props
        ...
        return ( 
                ...
                <Picker
                   ...
                   selectedValue={value}
                     ...
                     <Picker.Item label={title} key={`${statekey} -index`} value={""}/>
                    {searcharray.map(p=>(<Picker.Item label={p} key={`${statekey} ${p}`} value={p}/>))}
